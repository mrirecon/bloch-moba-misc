...
# Load data
# bart twixread -A /home/ague/archive/vol/2023-01-30_MRTG_BLMB_0007/raw/meas_MID00071_FID01796_IR_bSSFP_BR256_1ms_IMT_Radial_513d35c9_develop__bssfp1ms.dat _raw
bart copy ${REL_PATH}/../data/ksp_45 _raw
...
bart traj -x $SAMPLES -y $((FRAMES*SPOKES)) -s13 -G -D -r _traj
