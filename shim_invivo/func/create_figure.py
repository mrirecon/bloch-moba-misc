...
if __name__ == "__main__":
	...
	ax2.set_title("No Shim", fontsize=FS+5)
	...
	ax2.set_title("Prior Shim", fontsize=FS+5)
	...
	ax2.text(0.03*np.shape(bloch_short_t1_Shimm)[0], 0.03*np.shape(bloch_short_t1_Shimm)[0], '$\\bf{T}_{1,B,Shim}$', fontsize=FS+5, color=TCOLOR)
	...
	ax3.text(0.03*np.shape(bloch_short_t2_Shimm)[0], 0.03*np.shape(bloch_short_t2_Shimm)[0], '$\\bf{T}_{2,B,Shim}$', fontsize=FS+5, color=TCOLOR)
	...
	ax2.text(0.03*np.shape(diff_map_m)[0], 0.03*np.shape(diff_map_m)[0], '$\\bf{T}_{1,B}-\\bf{T}_{1,B,Shim}$', fontsize=FS, color=TCOLOR)
	...
	ax3.text(0.03*np.shape(diff_map_m)[0], 0.03*np.shape(diff_map_m)[0], '$\\bf{T}_{2,B}-\\bf{T}_{2,B,Shim}$', fontsize=FS, color=TCOLOR)
