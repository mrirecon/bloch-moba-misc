...
if __name__ == "__main__":
	...
	ax2.set_title("15 binned Spokes", fontsize=FS+5)
	ax2.set_ylabel("T$_1$ / s", fontsize=FS+5)
	# ax2.set_ylabel("short RF", fontsize=FS)

	ax2.text(0.03*np.shape(bloch_short_t1_noShimm)[0], 0.03*np.shape(bloch_short_t1_noShimm)[0], '$\\bf{T}_{1,B,Bin}$', fontsize=FS+5, color=TCOLOR)
	...
	ax2.text(0.03*np.shape(bloch_short_t2_noShimm)[0], 0.03*np.shape(bloch_short_t2_noShimm)[0], '$\\bf{T}_{2,B,Bin}$', fontsize=FS+5, color=TCOLOR)
	...
	ax2.set_title("No Binning", fontsize=FS+5)
	...
	ax2.text(0.03*np.shape(bloch_short_t1_Shimm)[0], 0.03*np.shape(bloch_short_t1_Shimm)[0], '$\\bf{T}_{1,B}$', fontsize=FS+5, color=TCOLOR)
	...
	ax3.text(0.03*np.shape(bloch_short_t2_Shimm)[0], 0.03*np.shape(bloch_short_t2_Shimm)[0], '$\\bf{T}_{2,B}$', fontsize=FS+5, color=TCOLOR)
	...
	ax2.text(0.03*np.shape(diff_map_m)[0], 0.03*np.shape(diff_map_m)[0], '$\\bf{T}_{1,B,Bin}-\\bf{T}_{1,B}$', fontsize=FS, color=TCOLOR)
	...
	ax3.text(0.03*np.shape(diff_map_m)[0], 0.03*np.shape(diff_map_m)[0], '$\\bf{T}_{2,B,Bin}-\\bf{T}_{2,B}$', fontsize=FS, color=TCOLOR)
