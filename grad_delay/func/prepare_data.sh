...
LL | Bloch_flash | Bloch_short)

	GRAD_DELAY=$(bart estdelay -R _traj4 data4)
	;;

Bloch_short_delay)

	GRAD_DELAY="0:0:0" #-1.145222:-1.042367:-0.008579
	;;
esac


bart traj -x $SAMPLES -y $SPOKES -s${GA} -G -t $FRAMES -D -r -O -q ${GRAD_DELAY} _traj5
